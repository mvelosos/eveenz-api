class Api::V1::Search::SearchService
  ...
  def search_accounts
    accounts = Account.search(@params[:query], misspellings: { edit_distance: 5 }, page: 1, per_page: 50)
  ...
  def search_events
    events = Event.search(@params[:query], misspellings: { edit_distance: 5 }, page: 1, per_page: 50)
